...
// Connect to MongoDB
mongoose
  .connect(process.env.MONGODB_URI + 'quizdb')
  .then(() => {
...
// Define Routes
// Root route to handle GET request for '/'
app.get('/', (req, res) => {
  // res.send('Welcome to the Leben-de Backend!');
...
app.get('/questions', async (req, res) => {
  try {
    ...
    if (questions.length === 0) {
      console.log('Database connection string:', process.env.MONGODB_URI);
